...
public class CheckImgServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟�
		graphics2d.setFont(new Font("锟斤拷锟斤拷", Font.BOLD, 20));
		...
		for (int i = 0; i < 4; i++) {
			...
			// 锟斤拷锟斤拷一锟斤拷锟斤拷锟斤拷锟斤拷锟�
			int index = random.nextInt(words.length()); // 锟斤拷锟斤拷锟斤拷锟斤拷锟� 0 锟斤拷 length - 1
			// 锟斤拷锟斤拷锟侥革拷锟斤拷锟�
		...
		request.getSession().setAttribute("checkimg", sb.toString());
